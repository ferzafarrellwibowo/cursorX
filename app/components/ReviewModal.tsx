          ...
          <div className="shrink-0 border-b border-zinc-800 p-6 bg-zinc-950">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-xl font-bold text-zinc-100">Review Submission</h2>
                  <p className="text-xs text-zinc-500">Asset ID: {submission.asset_id}</p>
                </div>
              </div>
              <button
                onClick={onClose}
              ...
              <form onSubmit={handleAcceptClick} className="space-y-5">
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 rounded-xl bg-zinc-900 border border-zinc-800 text-zinc-100 font-mono text-xs focus:border-zinc-700 transition-all duration-300 focus:outline-none"
                  />
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-3 rounded-xl bg-zinc-900 border border-zinc-800 text-zinc-100 focus:border-zinc-700 transition-all duration-300 text-sm appearance-none focus:outline-none"
                    >
                      {CATEGORIES.map((cat) => (
                ...
                {name && (
                  <div className="p-4 rounded-xl bg-zinc-900 border border-zinc-800">
                    <p className="text-[10px] uppercase tracking-wider text-zinc-500 mb-3">Preview</p>
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-zinc-500">{category} · {creator || "Unknown"}</p>
                      </div>
                    </div>
                  </div>
                )}
                ...
                <div className="flex gap-4 pt-4">
                  <button
                    ...
                    className="flex-1 py-3 rounded-xl font-semibold text-sm text-zinc-300 bg-zinc-900 border border-zinc-800 hover:bg-zinc-800 transition-all duration-300 disabled:opacity-50 flex items-center justify-center gap-2"
                  >
                  ...
                  <button
                    ...
                    className="flex-[2] py-3 rounded-xl font-semibold text-sm text-zinc-900 bg-zinc-100 hover:bg-zinc-300 transition-all duration-300 hover:shadow-lg disabled:opacity-50 flex items-center justify-center gap-2"
                  >
