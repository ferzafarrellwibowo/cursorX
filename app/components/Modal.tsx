    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-lg animate-modalIn">
        <div className="relative rounded-3xl overflow-hidden bg-[#12121a] border border-white/[0.08] shadow-2xl">
          ...
          <button
            onClick={onClose}
            className="absolute top-4 right-4 z-10 p-2 rounded-full bg-white/[0.06] border border-white/[0.1] hover:bg-white/[0.12] transition-all duration-300"
          >
            <svg
          ...
          {/* Cursor Preview Area */}
          <div className={`relative bg-gradient-to-br ${gradient} p-12 flex items-center justify-center`}>
          ...
          <div className="p-6 space-y-5">
              ...
              <button
                ...
                className={`p-2.5 rounded-xl border transition-all duration-300 ${
                  isFavorite
                    ...
                    : "bg-white/[0.04] border-white/[0.08] text-white/30 hover:text-pink-400 hover:border-pink-500/20"
                }`}
              >
                <svg
                  className="w-5 h-5"
            ...
            <div className="p-4 rounded-xl bg-white/[0.03] border border-white/[0.05]">
              ...
              <div className="flex items-center gap-3">
                <code className="flex-1 text-sm text-white/60 bg-white/[0.04] px-3 py-2 rounded-lg font-mono overflow-x-auto">
                  {cursor.imageId}
                </code>
                <button
