          ...
          <form onSubmit={handleSubmit} className="p-5 space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                disabled={isSubmitting}
                rows={4}
                className="w-full px-4 py-3 rounded-xl bg-white/[0.04] border border-white/[0.08] text-white placeholder-white/20 focus:outline-none focus:border-violet-500/50 focus:ring-1 focus:ring-violet-500/20 transition-all duration-300 text-sm resize-none disabled:opacity-50"
              />
